/*
 ...
 And I feel in the obrigation to say that it was pretty challenge for me to include and understang the principles behind the rotation animation at the 3D model for the planets using SceneKit, since I had to learn about Camera, Rotation, Pivot Point and other things to get that effect at the planets! But when I got the positive result, I felt so Happy!
